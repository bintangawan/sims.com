...
interface Announcement {
    ...
    scope_id?: number;
    role_name?: 'siswa' | 'guru' | 'admin'; // ← fix: union ketat, bukan string bebas
    published_at: string;
    created_at: string;
    updated_at: string;
    creator: Creator;
...
export default function Edit({ announcement, sections, userRole }: Props) {
    const { data, setData, put, processing, errors } = useForm<FormData>({
        ...
        role_name: (announcement.role_name ?? '') as FormData['role_name'], // ← aman untuk union
            ...
            <div className="space-y-6 p-6">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        {/* Gunakan userRole agar tidak unused & informatif */}
                        ...
                        <form onSubmit={submit} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <Select value={data.scope_type} onValueChange={handleScopeTypeChange}>
                                    ...
                                    <SelectContent>
                                        {/* Sembunyikan 'Global' untuk guru (konsisten dengan Create) */}
